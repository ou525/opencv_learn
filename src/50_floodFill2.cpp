...
int main( int argc, char** argv )
{
	...
	//载入原图
	g_srcImage = imread("./data/12.jpg", 1);
	...
	//创建Trackbar
	createTrackbar( "Low", "output", &g_nLowDifference, 255, 0 );
	createTrackbar( "Up" ,"output", &g_nUpDifference, 255, 0 );
	...
	{
		//先显示效果图
		imshow("output", g_bIsColor ? g_dstImage : g_grayImage);
